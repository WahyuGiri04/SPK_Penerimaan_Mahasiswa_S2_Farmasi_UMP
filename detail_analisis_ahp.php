                    ...
                    <div class="normal-table-list">
                        ...
                        <div class="bsc-tbl">
                            <table class="table table-sc-ex">
                                <?php $tampil->tampil_pembobotan_fix_kriteria();?> 
                            </table>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table">
                            <tr valign="top">
                                ...
                                <table class="table table-bordered">
                                    <?php $tampil->tampil_hitung_fix_prioritas_vektor();?> 
                                </table>
                                </td>
                                <td>
                                <table class="table table-bordered">
                                    <?php $tampil->tampil_hasil_fix_prioritas_vektor();?> 
                                </table>
                                </td>
                            </tr>
                        </table>
                        ...
                        <div class="bsc-tbl-cds">
                          <table border="0">
                            <tr>
                                ...
                                <td valign="top">
                                <table class="table table-bordered">
                                    <?php $tampil->tampil_hasil_fix_matrix_konsistensi();?> 
                                </table>
                                </td>
                            </tr>
                          </table>
                          ...
                          <br>
                            ...
                            <table  style="width: 20%; position: relative;">
                              ...
                              <tr>
                                <td rowspan="3"><font size="6">CR</font></td>
                                <td rowspan="3"><font size="6">=</font></td>
                                <td align="center"><font size="6" ><?php $tampil->fix_cr(); echo round($cr,4); ?> </font></td>
                              </tr>
                            </table>
                            <br>
                            <h2>Karena nilai CR ≤ 0,1 maka <b><?php $tampil->fix_cr(); echo $keterangan ; ?></b> </h2>
                        </div>
                    </div>
                </div>
            </div>
