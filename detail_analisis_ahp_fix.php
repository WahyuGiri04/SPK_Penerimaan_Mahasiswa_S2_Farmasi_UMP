                    ...
                    <div class="normal-table-list">
                        ...
                        <div class="bsc-tbl">
                            <table class="table table-sc-ex">
                                <?php $tampil->tampil_pembobotan_fix_kriteria_1($_GET['id_pendaftaran']);?> 
                            </table>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table">
                            <tr valign="top">
                                ...
                                <table class="table table-bordered">
                                    <?php $tampil->tampil_hitung_fix_prioritas_vektor_1($_GET['id_pendaftaran']);?> 
                                </table>
                                </td>
                                <td>
                                <table class="table table-bordered">
                                    <?php $tampil->tampil_hasil_fix_prioritas_vektor_1($_GET['id_pendaftaran']);?> 
                                </table>
                                </td>
                            </tr>
                        </table>
                        ...
                        <div class="bsc-tbl-cds">
                          <table border="0">
                            <tr>
                                ...
                                <td valign="top">
                                <table class="table table-bordered">
                                    <?php $tampil->tampil_hasil_fix_matrix_konsistensi_1($_GET['id_pendaftaran']);?> 
                                </table>
                                </td>
                            </tr>
                          </table>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="normal-table-list mg-t-30">
                        ...
                        <div class="bsc-tbl-st">
                            ...
                            <?php $tampil->fix_eigen_max_1($_GET['id_pendaftaran']);?> 
                            </table>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="bsc-tbl-bdr">
                          <br>
                            <table style="width: 20%; position: relative;">
                              <?php $tampil->fix_ci_1($_GET['id_pendaftaran']);?> 
                            </table>
                            <br>
                            ...
                            <table  style="width: 20%; position: relative;">
                              ...
                              <tr>
                                <td rowspan="3"><font size="6">CR</font></td>
                                <td rowspan="3"><font size="6">=</font></td>
                                <td align="center"><font size="6" ><?php $tampil->fix_cr_1($_GET['id_pendaftaran']); echo round($cr,4); ?> </font></td>
                              </tr>
                            </table>
                            <br>
                            <h2>Karena nilai CR ≤ 0,1 maka <b><?php $tampil->fix_cr_1($_GET['id_pendaftaran']); echo $keterangan ; ?></b> </h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="normal-table-list">
                        <div class="bsc-tbl">
                            <table>
                                <tr>
                                  <?php $tampil->fix_cr_1($_GET['id_pendaftaran']); echo $tombol ; ?>
                                </tr>
                            </table>
                        </div>
                    </div>
