                    ...
                    <div class="form-example-wrap mg-t-30">
                        ...
                        <div class="bsc-tbl">
                            <form action="simpan_penilaian.php" method="post" enctype="multipart/form-data">
                                <?php $tampil->tampil_penilaian();?>
                                <div class="row">
                                    <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                        <button class="btn btn-success notika-btn-success" onclick="return confirm('Apakah Data sudah BENAR ???');" ><i class="fa fa-save"> Simpan Data </i> </button>
                                    </div>
                                </div>
                            </form>
                        </div>
